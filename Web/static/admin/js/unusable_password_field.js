...
try {
    ...
    document.querySelectorAll('input[name="usable_password"]').forEach(option => {
        option.addEventListener('change', function() {
            ...
            const submit1 = document.querySelector('input[type_report="submit"].set-password');
            const submit2 = document.querySelector('input[type_report="submit"].unset-password');
